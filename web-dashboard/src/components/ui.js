...
export function activityBadge(type) {
  const s = { 'Inspection':'pill-amber', 'Feed':'pill-blue', 'Treatment':'pill-red', 'Harvest':'pill-green', 'Hive Added':'pill-green', 'Hive Death':'pill-red', 'Split':'pill-amber', 'Combined':'pill-blue', 'Converted':'pill-amber', 'Moved':'pill-blue', 'Note':'pill-blue' };
