    ...
    <header class="app-header px-5 py-3 sticky top-0 z-50" style="border-bottom: 1px solid var(--hive-border);">
      <div class="max-w-6xl mx-auto flex items-center justify-between">
        ...
        <div class="flex items-center gap-1">
          ...
          <button onclick="sessionStorage.removeItem('hive_user'); sessionStorage.removeItem('active_apiary'); localStorage.removeItem('hive_remember'); localStorage.removeItem('hive_user'); window.location.hash='#/login'" class="p-2 text-hive-muted hover:text-hive-red" title="Sign out">
