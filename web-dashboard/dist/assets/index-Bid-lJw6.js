...
(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(i){if(i.ep)return;i.ep=!0;const a=t(i);fetch(i.href,a)}})();const we={};let Y=null;function L(e,s){we[e]=s}function qe(e="#/login"){async function s(){const t=window.location.hash||e,n=sessionStorage.getItem("hive_user");if(!n&&t!=="#/login"){window.location.hash="#/login";return}if(n&&t==="#/login"){window.location.hash="#/apiary";return}let i=null,a={};const o=t.split("?")[0];for(const[l,d]of Object.entries(we)){const c=l.split("/"),p=o.split("/");if(c.length!==p.length)continue;let m=!0;const h={};for(let v=0;v<c.length;v++)if(c[v].startsWith(":"))h[c[v].slice(1)]=decodeURIComponent(p[v]);else if(c[v]!==p[v]){m=!1;break}if(m){i=d,a=h;break}}if(i){Y&&(Y(),Y=null);const l=document.getElementById("app"),d=await i(l,a);typeof d=="function"&&(Y=d)}}window.addEventListener("hashchange",s),s()}const ke="apiary_theme";function je(){localStorage.getItem(ke)==="light"&&document.documentElement.classList.add("light"),le()}function Re(){document.documentElement.classList.toggle("light");const e=document.documentElement.classList.contains("light");localStorage.setItem(ke,e?"light":"dark"),le()}function le(){const e=document.documentElement.classList.contains("light");document.querySelectorAll(".theme-icon-dark").forEach(s=>s.classList.toggle("hidden",e)),document.querySelectorAll(".theme-icon-light").forEach(s=>s.classList.toggle("hidden",!e)),document.querySelectorAll(".theme-knob").forEach(s=>{s.style.left=e?"14px":"2px"})}function $e(){document.querySelectorAll("#themeToggle").forEach(e=>{const s=e.cloneNode(!0);e.parentNode.replaceChild(s,e),s.addEventListener("click",()=>{Re()})}),le()}function G(e,s,t){const n=[];for(let i=0;i<6;i++){const a=Math.PI/3*i-Math.PI/6;n.push(`${e+t*Math.cos(a)},${s+t*Math.sin(a)}`)}return`M${n.join("L")}Z`}function Pe(){const a=[];for(let o=0;o<5;o++){const l=o%2===0?4:3;for(let d=0;d<l;d++){const c=d*140.4+(o%2===0?0:105.30000000000001)+78,p=650-o*156*.5-78,m=Math.sqrt(c*c+(650-p)*(650-p))/Math.sqrt(750*750+650*650),h=Math.max(0,1-m*2);h>.05&&a.push({x:c,y:p,opacity:h})}}return Se(750,650,a,78,"bl")}function Fe(){const a=[];for(let o=0;o<4;o++)for(let d=0;d<3;d++){const c=600-d*144-80,p=o*160*.5+80,m=Math.sqrt((600-c)*(600-c)+p*p)/Math.sqrt(600*600+500*500),h=Math.max(0,1-m*2.2);h>.05&&a.push({x:c,y:p,opacity:h})}return Se(600,500,a,80,"tr")}function Se(e,s,t,n,i){const a=document.documentElement.classList.contains("light"),o="http://www.w3.org/2000/svg",l=document.createElementNS(o,"svg");l.setAttribute("width","100%"),l.setAttribute("height","100%"),l.setAttribute("viewBox",`0 0 ${e} ${s}`),l.setAttribute("preserveAspectRatio","none");const d=document.createElementNS(o,"defs"),c=document.createElementNS(o,"filter");c.setAttribute("id",`emboss-${i}`),c.setAttribute("x","-20%"),c.setAttribute("y","-20%"),c.setAttribute("width","140%"),c.setAttribute("height","140%");const p=document.createElementNS(o,"feGaussianBlur");p.setAttribute("in","SourceAlpha"),p.setAttribute("stdDeviation","3"),p.setAttribute("result","blur");const m=document.createElementNS(o,"feDiffuseLighting");m.setAttribute("in","blur"),m.setAttribute("surfaceScale","6"),m.setAttribute("diffuseConstant","0.7"),m.setAttribute("result","diffuse"),m.setAttribute("lighting-color",a?"#c8b890":"#4a6a8a");const h=document.createElementNS(o,"feDistantLight");h.setAttribute("azimuth","315"),h.setAttribute("elevation","25"),m.appendChild(h);const v=document.createElementNS(o,"feSpecularLighting");v.setAttribute("in","blur"),v.setAttribute("surfaceScale","5"),v.setAttribute("specularConstant","0.4"),v.setAttribute("specularExponent","20"),v.setAttribute("result","specular"),v.setAttribute("lighting-color",a?"#e8dcc0":"#8ab4d8");const r=document.createElementNS(o,"feDistantLight");r.setAttribute("azimuth","315"),r.setAttribute("elevation","30"),v.appendChild(r);const u=document.createElementNS(o,"feComposite");u.setAttribute("in","specular"),u.setAttribute("in2","diffuse"),u.setAttribute("operator","arithmetic"),u.setAttribute("k1","0"),u.setAttribute("k2","1"),u.setAttribute("k3","1"),u.setAttribute("k4","0"),u.setAttribute("result","lit");const f=document.createElementNS(o,"feComposite");f.setAttribute("in","lit"),f.setAttribute("in2","SourceAlpha"),f.setAttribute("operator","in"),f.setAttribute("result","clipped");const w=document.createElementNS(o,"feMerge"),M=document.createElementNS(o,"feMergeNode");M.setAttribute("in","clipped");const y=document.createElementNS(o,"feMergeNode");y.setAttribute("in","SourceGraphic"),w.appendChild(M),w.appendChild(y),c.appendChild(p),c.appendChild(m),c.appendChild(v),c.appendChild(u),c.appendChild(f),c.appendChild(w),d.appendChild(c);const k=document.createElementNS(o,"filter");k.setAttribute("id",`shadow-${i}`),k.setAttribute("x","-30%"),k.setAttribute("y","-30%"),k.setAttribute("width","160%"),k.setAttribute("height","160%");const C=document.createElementNS(o,"feDropShadow");return C.setAttribute("dx","4"),C.setAttribute("dy","6"),C.setAttribute("stdDeviation","8"),C.setAttribute("flood-color",a?"rgba(0,0,0,0.15)":"rgba(0,0,0,0.5)"),k.appendChild(C),d.appendChild(k),l.appendChild(d),t.forEach(({x:I,y:N,opacity:x})=>{const A=document.createElementNS(o,"g");A.setAttribute("opacity",String(x));const j=document.createElementNS(o,"path");j.setAttribute("d",G(I,N,n*.92)),j.setAttribute("fill",a?"rgba(180,165,140,0.3)":"rgba(8,16,28,0.7)"),j.setAttribute("filter",`url(#shadow-${i})`),A.appendChild(j);const g=document.createElementNS(o,"path");g.setAttribute("d",G(I,N,n*.92)),g.setAttribute("fill",a?"rgba(215,205,185,0.6)":"rgba(14,28,48,0.85)"),g.setAttribute("filter",`url(#emboss-${i})`),A.appendChild(g);const b=document.createElementNS(o,"path");b.setAttribute("d",G(I,N,n*.92)),b.setAttribute("fill","none"),b.setAttribute("stroke",a?"rgba(255,255,255,0.4)":"rgba(255,255,255,0.06)"),b.setAttribute("stroke-width","1.5"),A.appendChild(b);const S=document.createElementNS(o,"path");S.setAttribute("d",G(I,N,n*.95)),S.setAttribute("fill","none"),S.setAttribute("stroke",a?"rgba(160,145,120,0.2)":"rgba(255,255,255,0.04)"),S.setAttribute("stroke-width","0.8"),A.appendChild(S),l.appendChild(A)}),l}function Oe(){ue(),new MutationObserver(()=>{document.querySelectorAll(".hex-corner-svg").forEach(s=>s.remove()),ue()}).observe(document.documentElement,{attributes:!0,attributeFilter:["class"]})}function ue(){const e=document.createElement("div");e.className="hex-corner-svg hex-corner-svg--bl",e.setAttribute("aria-hidden","true"),e.appendChild(Pe()),document.body.insertBefore(e,document.body.firstChild);const s=document.createElement("div");s.className="hex-corner-svg hex-corner-svg--tr",s.setAttribute("aria-hidden","true"),s.appendChild(Fe()),document.body.insertBefore(s,document.body.firstChild)}const ze="https://prod-25.ukwest.logic.azure.com:443/workflows/2a2177c3c7174e0cbd8fa0392b36fd17/triggers/manual/paths/invoke?api-version=2019-05-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=Mlt3jgZT4UQhN6-doEkU-FrAGZZWzneDHvmyBZfX8Sg",ve="https://prod-01.ukwest.logic.azure.com:443/workflows/3ee8a8759b6248d38b47c30ab29abca1/triggers/manual/paths/invoke?api-version=2019-05-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=6BX8eq06bY1I2fJMqMRuszsIsFTL8kDZ4yOQF66OD-c",pe="https://prod-00.ukwest.logic.azure.com:443/workflows/85b5d48749124f93ab929e8aacbecdf3/triggers/manual/paths/invoke?api-version=2019-05-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=ygYwSYDDTVPEwpSI5ynZ-8fJQd1aLaMEDuMFooN7w24";let B=[],O=[],D=[],V=[],ee=!1;async function We(){if(!ee)try{const[e,s,t,n]=await Promise.all([Q("hives"),Q("inspections"),Q("notes"),Q("tasks")]);B=e.map(Ue),O=s.map(Ye).sort((i,a)=>new Date(a.date)-new Date(i.date)),D=t.map(Ge),V=n.map(Qe),ee=!0}catch(e){console.error("Failed to load from Dataverse:",e),ee=!0}}async function Q(e){if(ve.includes("%%"))return console.warn(`Read flow not configured for ${e}`),[];const s=new URL(ve);s.searchParams.set("entity",e);const t=await fetch(s.toString());if(!t.ok)throw new Error(`Read ${e}: HTTP ${t.status}`);return t.json()}async function Ve(e,s,t,n){if(pe.includes("%%"))return console.warn("Write flow not configured"),null;const i=await fetch(pe,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({entity:e,operation:s,data:t,id:n})});if(!i.ok)throw new Error(`Write ${e}/${s}: HTTP ${i.status}`);const a=await i.text();return a?JSON.parse(a):null}function $(e,s,t,n){Ve(e,s,t,n).catch(i=>console.error("Async write failed:",i))}function se(e,s){if(!e)return s;try{return JSON.parse(e)}catch{return s}}function Ue(e){return{id:e.gr_hiveid,hiveName:e.gr_name,type:e.gr_hivetype||"Hive",hiveStyle:e.gr_hivestyle||"",status:e.gr_status||"Active",strength:e.gr_strength??0,beeType:e.gr_beetype||"",color:e.gr_color||"#f59e0b",queenMarked:!!e.gr_queenmarked,queenColor:e.gr_queencolor||null,queenYear:e.gr_queenyear||null,queenClipped:!!e.gr_queenclipped,queenSource:e.gr_queensource||"",queenAddedDate:e.gr_queenaddeddate?e.gr_queenaddeddate.slice(0,10):null,queenNotes:e.gr_queennotes||"",dateAdded:e.gr_dateadded?e.gr_dateadded.slice(0,10):new Date().toISOString().slice(0,10),orientation:e.gr_orientation||"vertical",components:se(e.gr_components,[])}}function U(e){return{gr_name:e.hiveName,gr_hivetype:e.type,gr_hivestyle:e.hiveStyle,gr_status:e.status,gr_strength:e.strength,gr_beetype:e.beeType,gr_color:e.color,gr_queenmarked:e.queenMarked,gr_queencolor:e.queenColor,gr_queenyear:e.queenYear,gr_queenclipped:e.queenClipped,gr_queensource:e.queenSource,gr_queenaddeddate:e.queenAddedDate,gr_queennotes:e.queenNotes,gr_components:JSON.stringify(e.components||[]),gr_dateadded:e.dateAdded,gr_orientation:e.orientation}}function Ye(e){return{id:e.gr_inspectionid||e.gr_name,date:e.gr_activitydate?e.gr_activitydate.slice(0,10):"",type:e.gr_activitytype||"Inspection",hive:e.gr_hivename||"",strength:e.gr_strength,queenSeen:!!e.gr_queenseen,broodSpotted:!!e.gr_broodspotted,queenCells:!!e.gr_queencells,temperament:e.gr_temperament||"",broodPattern:e.gr_broodpattern||"",weightLeft:e.gr_weightleft,weightRight:e.gr_weightright,weightTotal:e.gr_weighttotal,diseases:se(e.gr_diseases,[]),pests:se(e.gr_pests,[]),notes:e.gr_notes||"",weatherTemp:e.gr_weathertemp,weatherConditions:e.gr_weatherconditions||"",_dvId:e.gr_inspectionid}}function Ee(e){return{gr_name:e.id||"insp-"+Date.now(),gr_activitydate:e.date,gr_activitytype:e.type||"Inspection",gr_hivename:e.hive,gr_strength:e.strength,gr_queenseen:e.queenSeen,gr_broodspotted:e.broodSpotted,gr_queencells:e.queenCells,gr_temperament:e.temperament,gr_broodpattern:e.broodPattern,gr_weightleft:e.weightLeft,gr_weightright:e.weightRight,gr_weighttotal:e.weightTotal,gr_diseases:JSON.stringify(e.diseases||[]),gr_pests:JSON.stringify(e.pests||[]),gr_notes:e.notes,gr_weathertemp:e.weatherTemp,gr_weatherconditions:e.weatherConditions}}function Ge(e){return{id:e.gr_noteid||e.gr_name,text:e.gr_text||"",date:e.gr_notedate?e.gr_notedate.slice(0,10):"",pinned:!!e.gr_pinned,deleted:!!e.gr_deleted,hiveId:e.gr_hiveid||null,_dvId:e.gr_noteid}}function F(e){return{gr_name:e.id||"n"+Date.now(),gr_text:e.text,gr_notedate:e.date,gr_pinned:e.pinned,gr_deleted:e.deleted,gr_hiveid:e.hiveId||""}}function Qe(e){return{id:e.gr_taskid||e.gr_name,text:e.gr_text||"",done:!!e.gr_done,due:e.gr_duedate?e.gr_duedate.slice(0,10):null,deleted:!!e.gr_deleted,_dvId:e.gr_taskid}}function re(e){return{gr_name:e.id||"t"+Date.now(),gr_text:e.text,gr_done:e.done,gr_duedate:e.due,gr_deleted:e.deleted}}async function Je(){const e=await fetch(ze);if(!e.ok)throw new Error(`Telemetry fetch failed: HTTP ${e.status}`);return(await e.json()).map(t=>({weight:t.gr_weight,internalTemp:t.gr_internaltemp,batteryVoltage:t.gr_batteryvoltage,hiveHum:t.gr_hivehum,legTemp:t.gr_legtemp,timestamp:t.gr_readingtimestamp||t.createdon})).sort((t,n)=>new Date(t.timestamp)-new Date(n.timestamp))}const q={name:"Home Apiary",location:"Kidmore End, Reading RG4 9AY, UK",lat:51.509,lng:-.975};function Ce(){return O}function Ze(){const e={};for(const s of O)e[s.date]||(e[s.date]=[]),e[s.date].push(s);return Object.entries(e).sort(([s],[t])=>new Date(t)-new Date(s)).map(([s,t])=>({date:s,items:t,count:t.length}))}function Ke(e){return O.filter(s=>s.hive===e)}function Ae(){return[]}function Xe(e){const s={...e,id:e.id||"insp-"+Date.now()};O.unshift(s),$("inspections","create",Ee(s))}const ie=[{id:"hive-roof",name:"Roof",color:"#7a8078",height:14,category:"structure",nuc:!1},{id:"hive-floor",name:"Floor",color:"#8B8580",height:10,category:"structure",nuc:!1},{id:"hive-stand",name:"Hive Stand",color:"#A09080",height:34,category:"structure",nuc:!1},{id:"hive-stand-iot",name:"Hive Stand IOT",color:"#5B7A5E",height:38,category:"structure",nuc:!1},{id:"super",name:"Super",color:"#90968b",height:30,category:"box",nuc:!1},{id:"national-brood",name:"National Brood",color:"#90968b",height:45,category:"box",nuc:!1},{id:"14x12-brood",name:"14x12 Brood",color:"#90968b",height:63,category:"box",nuc:!1},{id:"queen-excluder",name:"Queen Excluder",color:"#BFA67A",height:6,category:"accessory",nuc:!1},{id:"hive-eke",name:"Hive Eke",color:"#A89068",height:18,category:"accessory",nuc:!1},{id:"nuc-roof",name:"Nuc Roof",color:"#7a8078",height:12,category:"structure",nuc:!0},{id:"nuc-floor",name:"Nuc Floor",color:"#8B8580",height:8,category:"structure",nuc:!0},{id:"nuc-stand",name:"Nuc Stand",color:"#A09080",height:30,category:"structure",nuc:!0},{id:"nuc-stand-iot",name:"Nuc Stand IOT",color:"#5B7A5E",height:34,category:"structure",nuc:!0},{id:"nuc-brood",name:"Nuc Brood Box",color:"#90968b",height:40,category:"box",nuc:!0},{id:"nuc-super",name:"Nuc Super",color:"#90968b",height:26,category:"box",nuc:!0},{id:"nuc-eke",name:"Nuc Eke",color:"#A89068",height:14,category:"accessory",nuc:!0}],et=["Swarm","Local","Home Bred","Buckfast","Native Black Bee","Carniolan","Italian","F1 Buckfast","Premium F1 Buckfast","UK F1 Buckfast","Premium UK F1 Buckfast","VSH Buckfast","UK Mated VSH Buckfast","Obsidian","Unknown"],tt=["National","14x12","Commercial","Langstroth","WBC","Top Bar","Poly","Other"],st=["Bred","Purchased","Swarm","Supersedure","Emergency Cell","Gift","Split","Unknown"],it=["Blue","White","Yellow","Red","Green","Pink"];function W(){return B}function H(e){return B.find(s=>s.id===e)}function Be(e){return e.id=e.id||"hive-"+Date.now(),e.dateAdded=e.dateAdded||new Date().toISOString().slice(0,10),e.status=e.status||"Active",B.push(e),$("hives","create",U(e)),e}function X(e,s){const t=B.findIndex(n=>n.id===e);return t===-1?null:(B[t]={...B[t],...s},$("hives","update",U(B[t]),e),B[t])}function nt(e){B=B.filter(s=>s.id!==e),$("hives","delete",null,e)}function at(e,s,t){const n=B.find(a=>a.id===e);if(!n)return;n.components||(n.components=[]);const i=Math.max(0,n.components.length-1);n.components.splice(i,0,{type:s}),$("hives","update",U(n),e)}function he(e,s){const t=B.find(n=>n.id===e);!t||!t.components||(t.components.splice(s,1),$("hives","update",U(t),e))}function me(e,s,t){const n=B.find(a=>a.id===e);if(!n||!n.components||t<0||t>=n.components.length)return;const[i]=n.components.splice(s,1);n.components.splice(t,0,i),$("hives","update",U(n),e)}function P(e){const s={...e,id:"insp-"+Date.now(),date:e.date||new Date().toISOString().slice(0,10)};O.unshift(s),$("inspections","create",Ee(s))}function ot(e,s,t){const n=H(e);if(!n)return null;const i=Be({hiveName:s,type:"Nuc",hiveStyle:n.hiveStyle,beeType:n.beeType,color:"#06b6d4",strength:50,queenMarked:!1,queenColor:null,queenYear:new Date().getFullYear(),orientation:"vertical",components:[{type:"nuc-roof"},{type:"nuc-brood"},{type:"nuc-floor"},{type:"nuc-stand"}]});return P({type:"Split",hive:n.hiveName,notes:`Split made — new nuc "${s}" created. ${t||""}`.trim(),strength:n.strength,queenSeen:!1,broodSpotted:!1}),P({type:"Split",hive:s,notes:`Split from ${n.hiveName}. ${t||""}`.trim(),strength:50,queenSeen:!1,broodSpotted:!1}),i}function lt(e,s,t){const n=H(e),i=H(s);!n||!i||(P({type:"Combined",hive:n.hiveName,notes:`Combined with ${i.hiveName}. ${t||""}`.trim(),strength:n.strength,queenSeen:!1,broodSpotted:!1}),P({type:"Combined",hive:i.hiveName,notes:`Combined into ${n.hiveName}. Hive deactivated. ${t||""}`.trim(),strength:0,queenSeen:!1,broodSpotted:!1}),X(s,{status:"Combined"}))}function rt(e,s){const t=H(e);t&&(P({type:"Hive Death",hive:t.hiveName,notes:s||"Colony died out.",strength:0,queenSeen:!1,broodSpotted:!1}),X(e,{status:"Dead",strength:0}))}function dt(e,s,t){const n=H(e);n&&P({type:"Moved",hive:n.hiveName,notes:`Moved to ${s}. ${t||""}`.trim(),strength:n.strength,queenSeen:!1,broodSpotted:!1})}const ct={"hive-roof":"nuc-roof","hive-floor":"nuc-floor","hive-stand":"nuc-stand",super:"nuc-super","national-brood":"nuc-brood","14x12-brood":"nuc-brood","hive-eke":"nuc-eke"},ut={"nuc-roof":"hive-roof","nuc-floor":"hive-floor","nuc-stand":"hive-stand","nuc-brood":"national-brood","nuc-super":"super","nuc-eke":"hive-eke"};function vt(e,s){const t=H(e);if(!t)return null;const n=t.type==="Hive",i=n?ct:ut,a=n?"Nuc":"Hive",o=(t.components||[]).map(l=>{if(n&&l.type==="queen-excluder")return null;const d=i[l.type];return d?{type:d}:l}).filter(Boolean);return P({type:"Converted",hive:t.hiveName,notes:`${n?"Downsized to Nuc":"Upgraded to Hive"}. ${s||""}`.trim(),strength:t.strength,queenSeen:!1,broodSpotted:!1}),X(e,{type:a,components:o}),H(e)}function Me(e=!1){return D.filter(s=>e||!s.deleted)}function pt(e){const s=D.find(t=>t.id===e);s&&(s.pinned=!s.pinned,$("notes","update",F(s),s._dvId||e))}function ht(e){const s=D.find(t=>t.id===e);s&&(s.deleted=!0,$("notes","update",F(s),s._dvId||e))}function mt(e,s){const t=D.find(n=>n.id===e);t&&(t.text=s,t.date=new Date().toISOString().slice(0,10),$("notes","update",F(t),t._dvId||e))}function gt(e,s=null){const t={id:"n"+Date.now(),text:e,date:new Date().toISOString().slice(0,10),pinned:!1,deleted:!1,hiveId:s};D.unshift(t),$("notes","create",F(t))}function xt(e){return D.find(s=>s.hiveId===e&&!s.deleted)||null}function ge(e,s){const t=D.find(n=>n.hiveId===e&&!n.deleted);if(t)s?(t.text=s,t.date=new Date().toISOString().slice(0,10),t.pinned=!0):t.deleted=!0,$("notes","update",F(t),t._dvId||t.id);else if(s){const n={id:"n"+Date.now(),text:s,date:new Date().toISOString().slice(0,10),pinned:!0,deleted:!1,hiveId:e};D.unshift(n),$("notes","create",F(n))}}function Le(e=!1){const s=V.filter(t=>!t.deleted);return e?s:s.filter(t=>!t.done)}function Ie(e){const s=V.find(t=>t.id===e);s&&(s.done=!s.done,$("tasks","update",re(s),s._dvId||e))}function ft(e){const s=V.find(t=>t.id===e);s&&(s.deleted=!0,$("tasks","update",re(s),s._dvId||e))}function bt(e,s){const t={id:"t"+Date.now(),text:e,done:!1,due:s,deleted:!1};V.unshift(t),$("tasks","create",re(t))}function yt(){return[{id:"esp32-1",name:"ESP32 Hive Scale",type:"ESP32",location:"Hive 5 - Survivor",status:"Online",battery:4.1,lastSeen:"2026-03-18T09:30:00Z",firmware:"v1.0.0",ip:"192.168.1.45"},{id:"sb-inside",name:"SwitchBot Inside",type:"SwitchBot",location:"Hive 5 - Survivor (inside)",status:"Online",battery:87,lastSeen:"2026-03-18T09:25:00Z",temp:32.5,humidity:68},{id:"sb-outside",name:"SwitchBot Outside",type:"SwitchBot",location:"Apiary (ambient)",status:"Online",battery:92,lastSeen:"2026-03-18T09:28:00Z",temp:14.2,humidity:55}]}const wt=["0e98bf2afda73d29f786212cd02fc542cb3307fea44f76f208f396b5fcd4ea98"];async function kt(e,s){const n=new TextEncoder().encode(`${e}:${s}`),i=await crypto.subtle.digest("SHA-256",n);return Array.from(new Uint8Array(i)).map(a=>a.toString(16).padStart(2,"0")).join("")}async function $t(e){e.innerHTML=`
  ...
  `,document.getElementById("loginForm").addEventListener("submit",async t=>{t.preventDefault();const n=document.getElementById("username").value.trim().toLowerCase(),i=document.getElementById("password").value,a=await kt(n,i);if(wt.includes(a))sessionStorage.setItem("hive_user",JSON.stringify({name:n.charAt(0).toUpperCase()+n.slice(1),role:"admin"})),window.location.hash="#/apiary";else{const o=document.getElementById("loginError");o.textContent="Invalid username or password",o.classList.remove("hidden")}}),document.getElementById("username").focus()}function St(e){const s=e>=80?"Strong":e>=50?"Fair":"Weak";return`<span class="inline-flex items-center gap-1.5">
    ...
    </header>`}function Et(e){return`<span class="${{Inspection:"pill-amber",Feed:"pill-blue",Treatment:"pill-red",Harvest:"pill-green","Hive Added":"pill-green","Hive Death":"pill-red",Split:"pill-amber",Combined:"pill-blue",Converted:"pill-amber",Moved:"pill-blue",Note:"pill-blue"}[e]||"pill-amber"}">${e}</span>`}function Z(e){const s=new Date(e),n=Math.floor((new Date-s)/864e5);return n===0?"Today":n===1?"Yesterday":n<7?`${n}d ago`:n<30?`${Math.floor(n/7)}w ago`:s.toLocaleDateString("en-GB",{day:"numeric",month:"short",year:n>365?"numeric":void 0})}function K(e,s,t,n=!1){return`<div class="border-b" style="border-color:var(--hive-border)">
    ...
    <div id="acc-${e}" class="accordion-content ${n?"open":""}">${t}</div>
      ...
      <div class="text-gray-600 text-xs text-center py-4">No components</div>
      ...
      </div>`;else if(w)c+=`<div style="width:${l+Math.round(4*a)}px; height:${v}px; background:${h.color}; border-radius: 0 0 2px 2px"></div>`;else if(u){const y=Math.max(3,Math.round(4*a)),k=Math.round(v*.28),C=v-k;c+=`<div class="flex flex-col items-center" style="width:${l+Math.round(16*a)}px">
        ...
        <div style="width:${y}px; background:${h.color}; height:${v}px; border-radius: 0 0 2px 2px"></div>
        <div class="flex-1 mx-0.5" style="background:${h.color}; height:${Math.round(v*.3)}px; border-radius: 0 0 2px 2px"></div>
        <div style="width:${y}px; background:${h.color}; height:${v}px; border-radius: 0 0 2px 2px"></div>
      </div>`}else if(M){const y=Math.max(7,Math.round(8*a));c+=`<div class="relative flex items-center justify-center" style="width:${l}px; height:${v}px; background:${h.color}">
        <span class="text-white/60 font-medium text-center leading-tight" style="font-size:${y}px">${h.name}</span>
        ${n?xe(i,m):""}
      </div>`}else{const y=Math.max(8,Math.round(10*a));c+=`<div class="relative flex items-center justify-center" style="width:${l}px; height:${v}px; background:${h.color}; border-left:2px solid rgba(0,0,0,0.12); border-right:2px solid rgba(0,0,0,0.12)">
        ...
        ${n?xe(i,m):""}
      </div>`}}),c+="</div>",c}function xe(e,s){return`<button onclick="document.dispatchEvent(new CustomEvent('hive-remove-component', {detail:{hiveId:'${e}',index:${s}}}))" class="absolute top-0 right-0.5 text-white/40 hover:text-white text-xs leading-none p-0.5" title="Remove">✕</button>`}function Te(e=[],s="#f59e0b"){if(!e||!e.length)return'<div class="w-full h-full flex items-center justify-center text-3xl">🏠</div>';const t=.35,n=He(e),i=Math.round((n?ae:ne)*t);let a='<div class="flex flex-col items-center justify-end h-full py-1">';return e.forEach(o=>{const l=de(o.type);if(!l)return;const d=n?Ct(l):l.height,c=Math.round(d*t);l.id.includes("roof")?a+=`<div class="rounded-t" style="width:${i+3}px; height:${c}px; background:${l.color}"></div>`:l.id.includes("stand-iot")?a+=`<div class="flex flex-col items-center" style="width:${i+8}px">
        ...
        <div style="width:1px; background:${l.color}; height:${c}px"></div>
      </div>`:l.id.includes("floor")?a+=`<div style="width:${i+2}px; height:${Math.max(2,c)}px; background:${l.color}"></div>`:l.category==="accessory"?a+=`<div style="width:${i}px; height:${Math.max(2,c)}px; background:${l.color}"></div>`:a+=`<div style="width:${i}px; height:${c}px; background:${l.color}; border-left:1px solid rgba(0,0,0,0.12); border-right:1px solid rgba(0,0,0,0.12)"></div>`}),a+="</div>",a}const At={0:"Clear Sky",1:"Mainly Clear",2:"Partly Cloudy",3:"Overcast",45:"Foggy",48:"Rime Fog",51:"Light Drizzle",53:"Drizzle",55:"Heavy Drizzle",61:"Light Rain",63:"Rain",65:"Heavy Rain",71:"Light Snow",73:"Snow",75:"Heavy Snow",77:"Snow Grains",80:"Light Showers",81:"Showers",82:"Heavy Showers",85:"Light Snow Showers",86:"Snow Showers",95:"Thunderstorm",96:"Thunderstorm + Hail",99:"Thunderstorm + Heavy Hail"};let J=null,fe=0;const Bt=10*60*1e3;async function _e(e,s){if(J&&Date.now()-fe<Bt)return J;const t=`https://api.open-meteo.com/v1/forecast?latitude=${e}&longitude=${s}&current=temperature_2m,relative_humidity_2m,weather_code,wind_speed_10m&timezone=auto`,n=await fetch(t);if(!n.ok)throw new Error(`Weather API: HTTP ${n.status}`);const a=(await n.json()).current,o=a.weather_code;return J={temp:Math.round(a.temperature_2m),conditions:At[o]||`Code ${o}`,humidity:a.relative_humidity_2m,windSpeed:Math.round(a.wind_speed_10m),icon:Mt(o)},fe=Date.now(),J}function Mt(e){return e===0||e===1?"☀️":e===2?"⛅":e===3?"☁️":e>=45&&e<=48?"🌫️":e>=51&&e<=55?"🌦️":e>=61&&e<=65?"🌧️":e>=71&&e<=77?"🌨️":e>=80&&e<=82?"🌦️":e>=85&&e<=86?"🌨️":e>=95?"⛈️":"🌤️"}async function Lt(e){const s=W(),t=Ze(),n=Me(),i=Le(),a=s.filter(o=>o.status==="Active");e.innerHTML=`
    ${E(q.name,!1,!0)}
  ...
  `,_e(q.lat,q.lng).then(o=>{const l=document.getElementById("liveWeather");l&&(l.textContent=`${o.temp}°C ${o.conditions}`)}).catch(()=>{const o=document.getElementById("liveWeather");o&&(o.textContent="—")}),document.querySelectorAll(".task-check").forEach(o=>{o.addEventListener("change",()=>{const l=o.dataset.task;Ie(l);const d=o.closest(".task-item");d&&(d.style.opacity="0.3",d.style.textDecoration="line-through",setTimeout(()=>d.remove(),600))})})}async function oe(e,s){var f,w,M,y,k,C,I,N,x,A,j;const t=s.id,i=W().find(g=>g.hiveName===t),a=[...Ke(t),...Ae().filter(g=>g.hive===t)].sort((g,b)=>new Date(b.date)-new Date(g.date));if(!i){e.innerHTML=`
      ${E("Not Found",!0)}
      ...
      </div>`;return}const o=i.strength>=80?"#22c55e":i.strength>=50?"#f59e0b":"#ef4444";i.queenYear&&new Date().getFullYear()-i.queenYear;const l=a.filter(g=>g.type==="Inspection"),d=l.length?new Date(l[0].date):null,c=d?Math.floor((new Date-d)/864e5):null,p=xt(i.id);let m="—";if(i.queenAddedDate){const g=new Date(i.queenAddedDate),b=new Date;let S=b.getFullYear()-g.getFullYear(),T=b.getMonth()-g.getMonth(),z=b.getDate()-g.getDate();z<0&&(T--,z+=new Date(b.getFullYear(),b.getMonth(),0).getDate()),T<0&&(S--,T+=12);const _=[];S>0&&_.push(`${S}y`),T>0&&_.push(`${T}m`),_.push(`${z}d`),m=_.join(" ")}const h={Green:"var(--hive-sage)",Pink:"#ec4899",Blue:"var(--hive-blue)",Yellow:"#eab308",Red:"var(--hive-red)",White:"#e5e7eb"};e.innerHTML=`
    ${E(i.hiveName,!0)}
        ...
        <div class="card p-5">
          ...
          <div class="space-y-2.5">
            <div class="flex items-center gap-2">
              ${i.queenMarked?`<span class="w-2.5 h-2.5 rounded-full flex-shrink-0" style="background:${h[i.queenColor]||"var(--hive-muted)"}"></span><span class="text-sm text-hive-text">${i.queenColor} Marked</span>`:'<span class="text-sm text-hive-muted">Unmarked</span>'}
            ...
            <div class="pt-2 border-t" style="border-color:var(--hive-border)">
              ...
              <div class="text-sm text-hive-text">Age: ${m}${i.queenYear?` (${i.queenYear})`:""}</div>
            </div>`:""}
  ...
  `;const v=document.getElementById("noteModal"),r=()=>v==null?void 0:v.classList.remove("hidden"),u=()=>v==null?void 0:v.classList.add("hidden");(f=document.getElementById("editHiveNote"))==null||f.addEventListener("click",r),(w=document.getElementById("noteModalBackdrop"))==null||w.addEventListener("click",u),(M=document.getElementById("noteModalClose"))==null||M.addEventListener("click",u),(y=document.getElementById("noteModalCancel"))==null||y.addEventListener("click",u),(k=document.getElementById("noteModalSave"))==null||k.addEventListener("click",()=>{var b;const g=(b=document.getElementById("noteModalText"))==null?void 0:b.value.trim();g&&(ge(i.id,g),u(),oe(e,s))}),(C=document.getElementById("noteModalDelete"))==null||C.addEventListener("click",()=>{confirm("Delete this hive note?")&&(ge(i.id,""),u(),oe(e,s))}),(I=e.querySelector('[data-op="split"]'))==null||I.addEventListener("click",()=>{const g=prompt('Name for the new nuc/hive (e.g. "Nuc 2 - Split"):');if(!g)return;const b=prompt("Split notes (optional):")||"";ot(i.id,g,b),window.location.hash="#/apiary"}),(N=e.querySelector('[data-op="combine"]'))==null||N.addEventListener("click",()=>{const g=W().filter(_=>_.id!==i.id&&_.status==="Active");if(!g.length){alert("No other active hives to combine with.");return}const b=g.map((_,De)=>`${De+1}. ${_.hiveName}`).join(`
`),S=prompt(`Combine ${i.hiveName} INTO which hive? (this hive will be deactivated)

${b}

Enter number:`);if(!S)return;const T=parseInt(S,10)-1;if(T<0||T>=g.length){alert("Invalid selection.");return}const z=prompt("Combine notes (optional):")||"";lt(g[T].id,i.id,z),window.location.hash="#/apiary"}),(x=e.querySelector('[data-op="dead"]'))==null||x.addEventListener("click",()=>{if(!confirm(`Mark "${i.hiveName}" as dead? This will deactivate the hive.`))return;const g=prompt("Notes on the death (optional):")||"";rt(i.id,g),window.location.hash="#/apiary"}),(A=e.querySelector('[data-op="move"]'))==null||A.addEventListener("click",()=>{const g=prompt("Where is the hive being moved to?");if(!g)return;const b=prompt("Move notes (optional):")||"";dt(i.id,g,b),alert(`${i.hiveName} move recorded to timeline.`),window.location.hash="#/hive/"+encodeURIComponent(i.hiveName)}),(j=e.querySelector('[data-op="convert"]'))==null||j.addEventListener("click",()=>{const g=i.type==="Hive"?"downsize to a Nuc":"upgrade to a full Hive";if(!confirm(`Convert "${i.hiveName}" — ${g}?

All components will be swapped to the matching type.`))return;const b=prompt("Conversion notes (optional):")||"",S=vt(i.id,b);S&&(window.location.hash="#/hive/"+encodeURIComponent(S.hiveName))})}const It="modulepreload",Nt=function(e){return"/"+e},be={},ye=function(s,t,n){let i=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),l=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));i=Promise.allSettled(t.map(d=>{if(d=Nt(d),d in be)return;be[d]=!0;const c=d.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${p}`))return;const m=document.createElement("link");if(m.rel=c?"stylesheet":It,c||(m.as="script"),m.crossOrigin="",m.href=d,l&&m.setAttribute("nonce",l),document.head.appendChild(m),c)return new Promise((h,v)=>{m.addEventListener("load",h),m.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${d}`)))})}))}function a(o){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=o,window.dispatchEvent(l),!l.defaultPrevented)throw o}return i.then(o=>{for(const l of o||[])l.status==="rejected"&&a(l.reason);return s().catch(a)})};async function Ht(e){e.innerHTML=`
  ...
  `}function Rt(e){const s=yt();e.innerHTML=`
    ${E("Device Health",!0)}
  ...
  `}function Pt(e,s){const t=s.id;let n=H(t);if(!n){e.innerHTML=`${E("Not Found",!0)}<div class="max-w-6xl mx-auto p-4 text-center py-16"><p class="text-hive-muted">Hive not found</p><a href="#/apiary" class="btn-primary inline-block mt-4">Back</a></div>`;return}function i(){n=H(t),e.innerHTML=`
      ...
      <main class="max-w-6xl mx-auto p-4 pb-8">
        ...
        <section class="card-surface">
          ...
          <div class="space-y-1">
            ${(n.components||[]).map((o,l)=>{const d=ie.find(p=>p.id===o.type);if(!d)return"";const c=(n.components||[]).length;return`
    ...
    `,e.querySelectorAll("[data-add-type]").forEach(o=>{o.addEventListener("click",()=>{at(t,o.dataset.addType),i()})}),e.querySelectorAll("[data-remove-idx]").forEach(o=>{o.addEventListener("click",()=>{he(t,parseInt(o.dataset.removeIdx,10)),i()})}),e.querySelectorAll("[data-move-up]").forEach(o=>{o.addEventListener("click",()=>{const l=parseInt(o.dataset.moveUp,10);me(t,l,l-1),i()})}),e.querySelectorAll("[data-move-down]").forEach(o=>{o.addEventListener("click",()=>{const l=parseInt(o.dataset.moveDown,10);me(t,l,l+1),i()})})}i();const a=o=>{o.detail.hiveId===t&&(he(t,o.detail.index),i())};return document.addEventListener("hive-remove-component",a),()=>document.removeEventListener("hive-remove-component",a)}function Ft(e,s){var l;const t=s.id,n=t&&t!=="new",a=(n?H(t):null)||{hiveName:"",type:"Hive",hiveStyle:"National",beeType:"Buckfast",strength:100,color:"#f59e0b",queenMarked:!1,queenColor:null,queenYear:new Date().getFullYear(),components:[{type:"roof"},{type:"deep-box"},{type:"stand"}]};e.innerHTML=`
  ...
  `;const o=document.getElementById("strengthSlider");o.addEventListener("input",()=>{document.getElementById("strengthVal").textContent=o.value+"%"}),document.getElementById("hiveForm").addEventListener("submit",d=>{d.preventDefault();const c={hiveName:document.getElementById("hiveName").value.trim(),type:document.getElementById("hiveType").value,hiveStyle:document.getElementById("hiveStyle").value,beeType:document.getElementById("beeType").value,color:a.color||"#f59e0b",strength:parseInt(o.value,10),queenYear:parseInt(document.getElementById("queenYear").value,10)||null,queenMarked:document.getElementById("queenMarked").value==="true",queenColor:document.getElementById("queenColor").value||null,queenClipped:document.getElementById("queenClipped").value==="true",queenSource:document.getElementById("queenSource").value||"Unknown",queenAddedDate:document.getElementById("queenAddedDate").value||null,queenNotes:document.getElementById("queenNotes").value.trim(),orientation:"vertical"};if(n)X(t,c),window.location.hash="#/hive/"+encodeURIComponent(c.hiveName);else{c.components=[{type:"roof"},{type:"deep-box"},{type:"stand"}];const p=Be(c);window.location.hash="#/build/"+p.id}}),n&&((l=document.getElementById("deleteBtn"))==null||l.addEventListener("click",()=>{confirm(`Delete "${a.hiveName}"? This cannot be undone.`)&&(nt(t),window.location.hash="#/apiary")}))}function Ot(e){function s(){var n;const t=Le(!0);e.innerHTML=`
          ...
          ${t.map(i=>`
            <div class="card flex items-center gap-3 p-4" data-id="${i.id}">
              ...
              <div class="flex-1 min-w-0">
                ...
                <span class="text-[10px] uppercase tracking-wider block mt-0.5 ${i.done?"text-hive-muted":"text-hive-gold"}">${i.due?Z(i.due):""}</span>
              </div>
    ...
    `,e.querySelectorAll(".toggle-task").forEach(i=>{i.addEventListener("change",()=>{Ie(i.dataset.tid),s()})}),e.querySelectorAll(".delete-task").forEach(i=>{i.addEventListener("click",()=>{ft(i.dataset.tid),s()})}),(n=document.getElementById("addTaskBtn"))==null||n.addEventListener("click",()=>{const i=prompt("New task:");if(!i)return;const a=prompt("Due date (YYYY-MM-DD, optional):")||"";bt(i,a||null),s()})}s()}function zt(e){function s(){var c,p,m,h,v;const t=Me(!1);e.innerHTML=`
      ${E("Notes",!0)}
      <main class="max-w-6xl mx-auto p-5 space-y-4">
        <div class="flex items-center justify-between mb-2">
    ...
    `,e.querySelectorAll(".pin-note").forEach(r=>{r.addEventListener("click",()=>{pt(r.dataset.nid),s()})}),e.querySelectorAll(".delete-note").forEach(r=>{r.addEventListener("click",()=>{ht(r.dataset.nid),s()})});const n=document.getElementById("noteModal"),i=document.getElementById("noteModalTitle"),a=document.getElementById("noteModalText");let o=null;const l=(r,u,f)=>{i.textContent=r,a.value=u,o=f,n==null||n.classList.remove("hidden"),setTimeout(()=>a.focus(),100)},d=()=>{n==null||n.classList.add("hidden"),o=null};(c=document.getElementById("addNoteBtn"))==null||c.addEventListener("click",()=>l("New Note","",null)),e.querySelectorAll(".edit-note").forEach(r=>{r.addEventListener("click",()=>l("Edit Note",r.dataset.ntext,r.dataset.nid))}),(p=document.getElementById("noteModalBackdrop"))==null||p.addEventListener("click",d),(m=document.getElementById("noteModalClose"))==null||m.addEventListener("click",d),(h=document.getElementById("noteModalCancel"))==null||h.addEventListener("click",d),(v=document.getElementById("noteModalSave"))==null||v.addEventListener("click",()=>{const r=a==null?void 0:a.value.trim();r&&(o?mt(o,r):gt(r),s())})}s()}function Wt(e){const t=new URLSearchParams(window.location.hash.split("?")[1]||"").get("date")||"";let n=Ce().filter(a=>a.type==="Inspection");t&&(n=n.filter(a=>a.date===t));const i=t?`Inspections — ${new Date(t).toLocaleDateString("en-GB",{day:"numeric",month:"long",year:"numeric"})}`:"All Inspections";e.innerHTML=`
    ${E(i,!0)}
    <main class="max-w-6xl mx-auto p-4 pb-8">
      <div class="flex items-center justify-between mb-4">
  ...
  `}const Vt=["Varroa mites","Nosema","Chalkbrood","Stonebrood","American Foulbrood","European Foulbrood"],Ut=["Waxmoth","Mice","Ants","Wasps","Small Hive Beetle","Hornets"],Yt=["","Compact","Spotty","Patchy","Drone-heavy","None visible"];function Gt(e,s){var N;const t=s.id,n=new URLSearchParams(window.location.hash.split("?")[1]||""),i=n.get("from")||"",a=n.get("date")||"",o=[...Ce(),...Ae()],l=o.find(x=>x.id===t)||o[parseInt(t,10)];if(!l){e.innerHTML=`
      ${E("Not Found",!0)}
      <div class="max-w-6xl mx-auto p-4 text-center py-16">
        <div class="text-5xl mb-4">🔍</div>
  ...
  `,Ne(e);let p=!0;const m=document.getElementById("lockToggle"),h=document.getElementById("lockIcon"),v=document.getElementById("lockLabel"),r=document.getElementById("saveBar"),u=e.querySelectorAll("input, textarea, select"),f=e.querySelectorAll(".temperament-pill");m.addEventListener("click",()=>{p=!p,u.forEach(x=>{x.id!=="weightTotal"&&(x.disabled=p)}),f.forEach(x=>x.disabled=p),p?(h.innerHTML='<path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z"/>',v.textContent="Locked",m.style.color="var(--hive-muted)",r.classList.add("hidden")):(h.innerHTML='<path stroke-linecap="round" stroke-linejoin="round" d="M13.5 10.5V6.75a4.5 4.5 0 119 0v3.75M3.75 21.75h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H3.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z"/>',v.textContent="Editing",m.style.color="var(--hive-gold)",r.classList.remove("hidden"))});const w=document.getElementById("strengthSlider"),M=document.getElementById("strengthValue");w.addEventListener("input",()=>{M.textContent=w.value+"%"}),f.forEach(x=>{x.addEventListener("click",()=>{p||(f.forEach(A=>A.className="temperament-pill btn-secondary flex-1 py-2 text-xs"),x.className="temperament-pill btn-primary flex-1 py-2 text-xs")})});const y=document.getElementById("weightLeft"),k=document.getElementById("weightRight"),C=document.getElementById("weightTotal"),I=()=>{const x=parseFloat(y.value)||0,A=parseFloat(k.value)||0;(x>0||A>0)&&(C.value=(x+A).toFixed(2))};y.addEventListener("input",I),k.addEventListener("input",I),(N=document.getElementById("saveBtn"))==null||N.addEventListener("click",()=>{const x=document.createElement("div");x.className="fixed top-20 left-1/2 -translate-x-1/2 z-[100] px-6 py-3 rounded-full text-sm font-medium animate-in",x.style.cssText="background:var(--hive-gold);color:#0B0D0E;box-shadow:0 4px 20px rgba(212,175,55,0.3)",x.textContent="Inspection updated",document.body.appendChild(x),setTimeout(()=>{x.style.opacity="0",setTimeout(()=>x.remove(),300)},2500)})}je();Oe();L("#/login",$t);L("#/apiary",Lt);L("#/hive/:id",oe);L("#/apiary-dashboard",Ht);L("#/inspect",qt);L("#/admin",jt);L("#/devices",Rt);L("#/build/:id",Pt);L("#/hive-form/:id",Ft);L("#/tasks",Ot);L("#/notes",zt);L("#/inspections",Wt);L("#/inspection/:id",Gt);window.addEventListener("hashchange",()=>setTimeout($e,50));We().then(()=>{qe("#/login"),setTimeout($e,100)});
