...
$inspections = @(
    @{ gr_name="a1"; gr_activitydate="2025-09-26"; gr_activitytype="Inspection"; gr_hivename="Hive 1 - Obsidian"; gr_strength=100; gr_queenseen=$false; gr_broodspotted=$false; gr_weightleft=15.83; gr_weightright=15.43; gr_weighttotal=31.26; gr_notes="Left 15.83 Right 15.43" },
    @{ gr_name="a2"; gr_activitydate="2025-09-26"; gr_activitytype="Inspection"; gr_hivename="Hive 2 - BMH"; gr_strength=100; gr_queenseen=$false; gr_broodspotted=$false; gr_weightleft=15.46; gr_weightright=13.90; gr_weighttotal=29.36; gr_notes="Left 15.46 right 13.90" },
    @{ gr_name="a3"; gr_activitydate="2025-09-26"; gr_activitytype="Inspection"; gr_hivename="Hive 4 - Carly"; gr_strength=71; gr_queenseen=$false; gr_broodspotted=$false; gr_weightleft=12.98; gr_weightright=13.04; gr_weighttotal=26.02; gr_notes="Left 12.98 right 13.04" },
    @{ gr_name="a4"; gr_activitydate="2025-09-26"; gr_activitytype="Inspection"; gr_hivename="Hive 5 - Survivor"; gr_strength=100; gr_queenseen=$false; gr_broodspotted=$false; gr_weightleft=15.81; gr_weightright=16.39; gr_weighttotal=32.20; gr_notes="Left 15.81 Right 16.39" },
    @{ gr_name="a5"; gr_activitydate="2025-09-26"; gr_activitytype="Inspection"; gr_hivename="Hive 6 - Backup"; gr_strength=100; gr_queenseen=$false; gr_broodspotted=$false; gr_weightleft=7.66; gr_weightright=7.27; gr_weighttotal=14.93; gr_notes="Left 7.66 Right 7.27" },
    ...
    @{ gr_name="a11"; gr_activitydate="2025-09-05"; gr_activitytype="Inspection"; gr_hivename="Hive 6 - Backup"; gr_strength=100; gr_queenseen=$false; gr_broodspotted=$false; gr_weightleft=6.69; gr_weightright=7.32; gr_weighttotal=14.01; gr_notes="Left 6.69 Right 7.32" },
    @{ gr_name="a12"; gr_activitydate="2025-09-05"; gr_activitytype="Inspection"; gr_hivename="Hive 5 - Survivor"; gr_strength=100; gr_queenseen=$false; gr_broodspotted=$false; gr_weightleft=12.76; gr_weightright=11.55; gr_weighttotal=24.31; gr_notes="Left 12.76 right 11.55" },
    @{ gr_name="a13"; gr_activitydate="2025-09-05"; gr_activitytype="Inspection"; gr_hivename="Hive 2 - BMH"; gr_strength=100; gr_queenseen=$false; gr_broodspotted=$false; gr_weightleft=12.66; gr_weightright=12.37; gr_weighttotal=25.03; gr_notes="Left 12.66 Right 12.37" },
    @{ gr_name="a14"; gr_activitydate="2025-09-05"; gr_activitytype="Inspection"; gr_hivename="Hive 1 - Obsidian"; gr_strength=100; gr_queenseen=$false; gr_broodspotted=$false; gr_weightleft=14.39; gr_weightright=13.93; gr_weighttotal=28.32; gr_notes="Left 14.39 Right 13.93" },
    @{ gr_name="a15"; gr_activitydate="2025-08-25"; gr_activitytype="Inspection"; gr_hivename="Hive 6 - Backup"; gr_strength=100; gr_queenseen=$false; gr_broodspotted=$false; gr_weightleft=5.71; gr_weightright=6.45; gr_weighttotal=12.16; gr_notes="Left 5.71 Right 6.45 added feed" },
    @{ gr_name="a16"; gr_activitydate="2025-08-25"; gr_activitytype="Inspection"; gr_hivename="Hive 5 - Survivor"; gr_strength=100; gr_queenseen=$false; gr_broodspotted=$false; gr_weightleft=12.75; gr_weightright=11.03; gr_weighttotal=23.78; gr_notes="Left 12.75 Right 11.03 added feed" },
    @{ gr_name="a17"; gr_activitydate="2025-08-25"; gr_activitytype="Inspection"; gr_hivename="Hive 2 - BMH"; gr_strength=100; gr_queenseen=$false; gr_broodspotted=$false; gr_weightleft=12.09; gr_weightright=11.66; gr_weighttotal=23.75; gr_notes="Left 12.09 Right 11.66 added feed" },
    @{ gr_name="a18"; gr_activitydate="2025-08-25"; gr_activitytype="Inspection"; gr_hivename="Hive 1 - Obsidian"; gr_strength=100; gr_queenseen=$false; gr_broodspotted=$false; gr_weightleft=13.33; gr_weightright=12.61; gr_weighttotal=25.94; gr_notes="Left 13.33 Right 12.61 added more feed" },
